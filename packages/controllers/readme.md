...
If needed, even more detail could be provided. For example, the "number" specifications in the query parameters coud also be OpenAPI scheme objects describing additional
requirements on the inputs. For more information, see the [Decorator reference](#decorator-reference).
