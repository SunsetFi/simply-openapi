...
export function querySpaceDelimitedExplodeValueDeserializer(
...
export function querySpaceDelimitedNonExplodeValueDeserializer(
  ctx: OperationRequestContext,
  param: ParameterObject,
  schema: SchemaObject,
  rawValue: string | string[],
  ...
  const values = rawValue.split(/\s|\%20/);
